...
class _GooglePlaceAutoCompleteTextFieldState
  ...
  getLocation(String text) async {
    String url =
        "https://poc.qa.openpass.com.ar/_cors/https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$text&key=${widget.googleAPIKey}";
    ...
    try {
      ...
      var errorHandler = e.toString();
      //print(errorHandler);
      //_showSnackBar("$errorHandler");
    }
  }
  ...
  Future<Response?> getPlaceDetailsFromPlaceId(Prediction prediction) async {
    ...
    var url =
        "https://poc.qa.openpass.com.ar/_cors/https://maps.googleapis.com/maps/api/place/details/json?placeid=${prediction.placeId}&key=${widget.googleAPIKey}";
